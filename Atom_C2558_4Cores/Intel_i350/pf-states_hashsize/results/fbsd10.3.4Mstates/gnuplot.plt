...
set title "Impact of pf.states_hashsize with 4M states (Netgate RCC-VE 4860, 4 cores Intel Atom C2558E)"
set xlabel "pf.states_hashsize value (power of 2)"
set ylabel "Packets per second (minimum size, 2M undir flows: 4M state entries)\n minimum,median,maximum values of 5 benchs"
