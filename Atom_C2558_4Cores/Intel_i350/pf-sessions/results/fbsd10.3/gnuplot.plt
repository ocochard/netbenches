...
set title "Impact of pf.hash_size table size on performance (Netgate RCC-VE 4860, 4 cores Intel Atom C2558E)"
set xlabel "pf.hash_size."
set ylabel "Packets per second (minimum size, 9600 pf states)\n minimum,median,maximum values of 5 benchs"
