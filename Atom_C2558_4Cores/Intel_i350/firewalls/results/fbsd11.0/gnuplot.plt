...
# Ploting!
plot "../10.3/gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 10.3" ls 1, \
	 "../10.3/gnuplot.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
	 "gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 11.0" ls 2, \
