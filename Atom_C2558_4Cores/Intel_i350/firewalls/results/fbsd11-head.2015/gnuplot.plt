...
set title "One year (2015) of fastforwarding performance evolution with ipfw/pf impact\n Platform: Netgate RCC-VE 4860 (4 cores Intel Atom C2558E, Intel I354 NIC)"
set xlabel "FreeBSD 11 head svn revision number \n Note: fastforwarding enabled for ipfw and pf benchs\n2 firewall rules only, GENERIC-NODEBUG kernel, harvest.mask=351"
...
plot "fastforwarding.data" using 1:2:xtic(1) title 'fastforwarding' with linespoints ls 2, \
     "" using 1:2:3:4 with yerrorbars ls 1 notitle, \
 "ipfw-statefull.data" using 1:2 title 'ipfw (statefull)' with linespoints ls 3, \
 "" using 1:2:3:4 with yerrorbars ls 2 notitle, \
 "pf-statefull.data" using 1:2 title 'pf (statefull)' with linespoints ls 4, \
 "" using 1:2:3:4 with yerrorbars ls 1 notitle
