...
set title "One year (2017) of forwarding performance\n Platform: Netgate RCC-VE 4860, 4-core Intel Atom C2558E with Intel i354 NIC"
...
# Specific labels
set arrow 1 from 314500,650000 to 315217,800926
set label 1 "r315217 \"IFLIB update\"" at 314000,600000 left noenhanced

set arrow 2 from 325000,350000 to 327013,512374
set label 2 "r3327013 \"Support attaching tx queues to cpus\"" at 318500,300000 left noenhanced

set arrow 3 from 313000,550000 to 312205,843863
set label 3 "r311849  \"Migrate e1000 to the IFLIB framework\"" at 312000,500000 left noenhanced

set arrow 4 from 325000,650000 to 323954,909878
set label 4 "r323954 \"Have ifmp_ring_enqueue() abdicate\n instead of switch to a consumer\"" at 320000,650000 left noenhanced


# Ploting!

plot "forwarding.data" using 1:2:xtic(1) title 'inet4' with linespoints ls 2, \
