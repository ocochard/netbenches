...
set title noenhanced "Impact of enabling ipfw/pf/ipf on FreeBSD 13-main c255632 forwarding performance\nHP DL360p (8 cores Intel Xeon E5-2650 2.60GHz with Chelsio T540-CR)"
set xlabel "Note: 2 static routes, minimum firewall rules, ICMP redirect disabled, HT disabled"
...
plot "inet4.data" using 2:3:4:xticlabels(1) with histogram title "inet4" ls 2, \
	...
	h(x) with lines title "min. req for 10Gb/s bidir with simple IMIX dist." ls 5 lw 4
