...
set title "Impact of queue size on forwarding performance\n (HP ProLiant DL360p Gen8 with 8 cores Intel Xeon E5-2650 2.60GHz, HT off)"
set xlabel "Chelsio T540-CR queues number, harvest.mask=351"
...
# Ploting!
plot "11-stable.data" using 0:2:xtic(1) with lines title "FreeBSD 11-stable r312663" ls 3, \
	 "11-stable.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
	 "routing.data" using 0:2:xtic(1) with lines title "FreeBSD projects/routing" ls 2, \
	 "routing.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
	 "10.2.data" using 0:2:xtic(1) with lines title "FreeBSD 10.2" ls 1, \
	 "10.2.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle