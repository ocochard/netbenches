...
# Ploting!
plot e(x) with lines title "10 Gigabit line-rate" linestyle 2 lw 5 ps 4, \
	f(x) with lines title "linear reference" linestyle 3, \
	 "Dell-Chelsio.data" using 0:2:xtic(1) with lines title "FreeBSD 12head r328260 with AFDATA and RADIX patches" ls 1, \
	 "Dell-Chelsio.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle
