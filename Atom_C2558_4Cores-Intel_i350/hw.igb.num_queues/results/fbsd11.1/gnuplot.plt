...
set title noenhanced  "Number of NIC queues impact on forwarding performance on Netgate RCC-VE 4860\n(4 cores Intel Atom C2558E, Intel i350)"
set xlabel noenhanced  "hw.igb.num_queues"
...
# Ploting!
plot "netgate.data" using 0:2:xtic(1) with lines title "FreeBSD 11.1" ls 2, \
