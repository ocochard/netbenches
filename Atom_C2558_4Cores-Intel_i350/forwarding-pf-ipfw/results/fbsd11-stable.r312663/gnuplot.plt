...
set title "Impact of enabling ipfw/pf on forwarding performance (Netgate RCC-VE 4860, 4 cores Intel Atom C2558E)"
set xlabel "2 firewall rules only and harvest.mask=351"
...
# Ploting!
plot "10.3.data" using 0:2:xtic(1) with boxes title "FreeBSD 10.3" ls 2, \
	 "10.3.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
	"gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 11-stable r312663" ls 3, \
	 "gnuplot.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
	 "11.0.data" using 0:2:xtic(1) with boxes title "FreeBSD 11.0" ls 1, \
	 "11.0.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle
