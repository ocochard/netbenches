...
set title "Impact of enabling fastforwarding/ipfw/pf on forwarding performance (Netgate RCC-VE 4860, 4 cores Intel Atom C2558E)"
...
# Ploting!
plot "11-gnn-light.data" using 0:2:xtic(1) with boxes title "FreeBSD 11-head r287478 with D3737" ls 1, \
	 "11-gnn-light.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
	 "head-light.data" using 0:2:xtic(1) with boxes title "FreeBSD 11-head r287478" ls 2, \
	 "head-light.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle
