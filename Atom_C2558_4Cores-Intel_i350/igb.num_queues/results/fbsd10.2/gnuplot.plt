...
set title "Impact of Intel i350 queue number on FreeBSD fastforwarding performance (Netgate RCC-VE 4860, 4 cores Intel Atom C2558E)"
set xlabel "Intel i350 queue number"
...
# Ploting!
plot "gnuplot.data" with errorbars title 'FreeBSD 10.2' ls 1, \
