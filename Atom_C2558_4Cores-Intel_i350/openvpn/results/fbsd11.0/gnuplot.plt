...
set title "OpenVPN performance on Netgate RCC-VE 4860 (4 cores Intel Atom C2558E)"
...
# Ploting!
plot "gnuplot.data.max" using 0:2:xtic(1) with boxes title "FreeBSD 11.0, OpenVPN 2.4.0" ls 1, \
