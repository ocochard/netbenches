...
set title "Impact of pf.states_hashsize with default max 10K states (Netgate RCC-VE 4860, 4 cores Intel Atom C2558E)"
set xlabel "pf.states_hashsize value (power of 2)"
set ylabel "Packets per second (minimum size, 4900 flows: 9800 state entries)\n minimum,median,maximum values of 5 benchs"
