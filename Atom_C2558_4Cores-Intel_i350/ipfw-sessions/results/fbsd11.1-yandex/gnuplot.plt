...
# output
set terminal png truecolo transparent size 1920,1080 font "Gill Sans,22"
...
set title noenhanced "ipfw state numbers impact on forwarding performance (Netgate RCC-VE 4860, 4 cores Intel Atom C2558E)"
set xlabel noenhanced "Number of UDP flow (=ipfw dynamic rules)\nnet.inet.ip.fw.dyn_buckets=65536 and net.inet.ip.fw.dyn_max=4000000"
...
# Ploting!
plot "gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 11.1 with Yandex's patches" ls 2, \
