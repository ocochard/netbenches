...
set title noenhanced "Impact of firewalls states number on FreeBSD 12 r328509-yandex forwarding performance\n(harvest.mask=351, patches: AFDATA,RADIX locks and IPFW lockless)\nHP ProLiant DL360p Gen8 with 8 cores Intel Xeon E5-2650 2.60GHz, Chelsio T540-CR"
set xlabel noenhanced "Number of UDP flows"
...
plot f(x) with lines title "Minimum throughput requiered" linestyle 4 lw 4, \
	"ipfw-states.data" using 2:3:4:xticlabels(1) with histogram title "ipfw" ls 2, \
	 "pf-states.data" using 2:3:4:xticlabels(1) with histogram title "pf " ls 3,
