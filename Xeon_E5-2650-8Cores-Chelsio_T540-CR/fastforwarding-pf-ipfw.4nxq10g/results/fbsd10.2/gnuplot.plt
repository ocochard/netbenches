...
set xlabel "Chelsio 10-Gigabit T540-CR. fastforwarding is enabled for all ipfw and pf benchs. 2 firewall rules only"
...
# Ploting!
plot "gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 10.2 (hw.cxgbe.nXxq10g=4)" ls 1, \
	 "gnuplot.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
     "../../../fastforwarding-pf-ipfw/results/fbsd10.2/gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 10.2 (default hw.cxgbe.nXxq10g=ncpu=8)" ls 2, \
	 "../../../fastforwarding-pf-ipfw/results/fbsd10.2/gnuplot.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
