...
set title "Comparing benefit of patch D3737 on forwarding performance (HP ProLiant DL360p Gen8 with 8 cores Intel Xeon E5-2650)"
set xlabel "Note: Chelsio T540-CR with 4 queues. harvest.mask=351"
...
set key on outside bmargin bottom right

# Ploting!
plot  "gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 11-head r287478 D3737 patched" ls 1, \
	 ...
	 "../fbsd11-head.r287478/gnuplot.data" using 0:2:3:4 with yerrorbars lc rgb 'blue' pt 1 lw 2 notitle
