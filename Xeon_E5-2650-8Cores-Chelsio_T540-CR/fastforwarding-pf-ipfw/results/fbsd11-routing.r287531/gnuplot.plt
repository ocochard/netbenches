...
set xlabel "Note: Chelsio T540-CR with default 8 queues, fastforwarding enabled for ipfw and pf benchs. 2 firewall rules only. harvest.mask=351"
...
plot "gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 11-routing (r287531)" ls 1, \
	 ...
	 "../fbsd11-head.r287478/gnuplot.data" using 0:2:3:4 with yerrorbars lc rgb 'grey' pt 1 lw 2 notitle, \
     "../fbsd10.2/gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 10.2" ls 3, \
	 "../fbsd10.2/gnuplot.data" using 0:2:3:4 with yerrorbars lc rgb 'white' pt 1 lw 2 notitle
