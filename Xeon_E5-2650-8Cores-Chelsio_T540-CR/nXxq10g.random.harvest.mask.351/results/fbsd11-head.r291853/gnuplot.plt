...
set title "Impact of commit r291853 (Remove LLE read lock from IPv4 fast path) on FreeBSD forwarding performance"
set xlabel "HP ProLiant DL360p Gen8 with 8 cores Intel Xeon E5-2650 2.60GHz(HT off)\n 2 static routes, Chelsio T540-CR queue number, harvest.mask=351"
...
# Ploting!
plot "291852.gnuplot.data" with errorbars title 'r291852' ls 1, \
	"291852.gnuplot.data" with lines notitle ls 1, \
	"291853.gnuplot.data" with errorbars title 'r291853' ls 2, \
	"291853.gnuplot.data" with lines notitle ls 2
