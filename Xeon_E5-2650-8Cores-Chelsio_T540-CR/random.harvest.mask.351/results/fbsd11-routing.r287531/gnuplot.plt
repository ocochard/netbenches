...
set title "Impact of random.harvest.mask on fastforwarding performance of project/routing (r287531)"
...
# Ploting!
plot "gnuplot.data" with errorbars title 'random.harvest.mask=351' ls 1, \
	"gnuplot.data" with lines notitle ls 1, \
	"../../../nXxq10g/results/fbsd11-routing.r287531/gnuplot.data" with errorbars title 'random.harvest.mask=511 (default)' ls 2, \
