...
set title "ipfw/pf's impact on forwarding performance (PC Engines APU, 2 cores AMD G-T40E and RTL8111E)"
...
# Ploting!
plot "gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 11-stable r312663" ls 1, \
	 "gnuplot.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
	 "11.0.data" using 0:2:xtic(1) with boxes title "FreeBSD 11.0" ls 2, \
