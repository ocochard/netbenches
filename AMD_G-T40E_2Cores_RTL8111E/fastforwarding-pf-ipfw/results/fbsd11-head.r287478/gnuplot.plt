...
# Ploting!
plot "../fbsd10.2/gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 10.2" ls 2, \
	 "../fbsd10.2/gnuplot.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
	 "gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 11-head r287478" ls 1, \
