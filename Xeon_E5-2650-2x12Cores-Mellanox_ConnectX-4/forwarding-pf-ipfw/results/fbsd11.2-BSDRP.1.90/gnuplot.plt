...
set key at 7,12000000 top right

f(x)=14800000
e(x)=7000000
# Ploting!
plot f(x) with lines title "10Gigabit line-rate" ls 3 lw 4, \
     e(x) with lines title "Minimum throughput requiered for 10Gbit full-duplex IMIX" ls 4 lw 4, \
