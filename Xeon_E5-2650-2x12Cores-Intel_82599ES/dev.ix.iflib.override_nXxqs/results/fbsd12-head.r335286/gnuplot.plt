...
set xlabel noenhanced "Number of queues\n(HyperThreading and LRO/TSO disabled, harvest.mask=351, FreeBSD 12-head r335286)"
...
f(x) = x<=16 ? 586850 * ( x + 1 )  : 1/0
e(x) = 14880960

# Ploting!
plot "gnuplot.data" using 0:2:xtic(1) with lines title "Intel 82599ES NIC (16 queues maximum)" ls 1, \
