...
set title "Impact of RX/TX queue number on fastforwarding performance (SuperMicro 5018A-FTN4, 8 cores ATOM C2758)"
set xlabel "Chelsio 10-Gigabit T540-CR queue number\n(fastforwarding enabled and harvest.mask=351)"
...
# Ploting!
plot "10.3.data" with errorbars title 'FreeBSD 10.3' ls 2, \
     "10.3.data" with lines notitle ls 1
