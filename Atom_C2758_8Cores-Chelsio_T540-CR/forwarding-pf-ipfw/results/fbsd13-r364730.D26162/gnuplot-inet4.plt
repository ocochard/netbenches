...
set title noenhanced "Impact of r364730 (D26162) on inet4 forwarding and firewalling performance\nSuperMicro SuperServer 5018A-FTN4 with 8 cores Atom C2758 and Chelsio T540-CR"
...
h(x)=7000000
# Ploting!
plot "r364729-inet4.data" using 2:3:4:xticlabels(1) with histogram title "r364729" ls 2, \
	 "r364730-inet4.data" using 2:3:4:xticlabels(1) with histogram title "r364730 (D26162)" ls 3
#	h(x) with lines title "min. req for 10Gb/s bidir with simple IMIX" ls 5 lw 4
