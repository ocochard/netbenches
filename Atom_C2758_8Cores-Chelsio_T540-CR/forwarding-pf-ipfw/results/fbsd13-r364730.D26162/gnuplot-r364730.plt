...
h(x)=7000000
# Ploting!
plot "r364730-inet4.data" using 2:3:4:xticlabels(1) with histogram title "inet4" ls 2, \
	 "r364730-inet6.data" using 2:3:4:xticlabels(1) with histogram title "inet6" ls 3
