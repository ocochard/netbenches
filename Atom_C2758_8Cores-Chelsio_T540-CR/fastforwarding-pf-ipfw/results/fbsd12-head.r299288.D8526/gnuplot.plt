...
set title "Impact of enabling ipfw and pf on forwarding performance (SuperMicro 5018A-FTN4, 8 cores ATOM C2758)"
set xlabel "Note: Chelsio T540-CR with default queues(8), 2 firewall rules only, harvest.mask=351"
