...
# output
set terminal png truecolor enhanced size 1920,1080 font "Gill Sans,22"
...
set title "Impact of mjg\\@'s commit r303643\n\"Implement trivial backoff for locking primitives\" on forwarding/ipfw/pf performance\n Platform: SuperMicro 5018A-FTN4, 8 cores ATOM C2758"
set xlabel "Note: Chelsio T540-CR NIC with default queues number (=ncpu =8 here)\n2 firewall rules only, , harvest.mask=351"
...
# Ploting!
plot "r303643.data" using 0:2:xtic(1) with boxes title "FreeBSD 12-head r303643" ls 2, \
	 "r303643.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
	 "r303642.data" using 0:2:xtic(1) with boxes title "FreeBSD 12-head r303642" ls 1, \
	 "r303642.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle
