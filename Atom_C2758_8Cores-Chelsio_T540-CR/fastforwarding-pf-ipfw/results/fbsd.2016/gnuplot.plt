...
set title "One year (2016) of pf/ipfw's impact on forwarding performance\n Platform: SuperMicro 5018A-FTN4, 8 cores ATOM C2758 with Chelsio T540-CR"
...
# Specific labels
set arrow 1 from 300000,1900000 to 303643,1140372
set label 1 "r303643 \"Implement trivial backoff for locking primitives\"(mjg@)" at 294000,2000000 left noenhanced

set arrow 2 from 304000,2600000 to 309257,3141402.5
set label 2 "r309257 \"Rework ip_tryforward() to use FIB4 KPI\"(ae@)" at 301000,2500000 left noenhanced
