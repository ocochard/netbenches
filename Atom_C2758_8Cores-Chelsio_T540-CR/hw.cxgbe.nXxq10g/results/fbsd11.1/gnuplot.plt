...
set title "Number of queues impact on forwarding performance\n(SuperMicro 5018A-FTN4, 8 cores ATOM C2758, Chelsio T540-CR)"
...
# Ploting!
plot "SM-Chelsio.data" using 0:2:xtic(1) with lines title "FreeBSD 11.1" ls 1, \
	 "SM-Chelsio.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle
