...
set title "Impact of binding NIC queue to core on fastforwarding performance (Supermicro X10DRi-LN4+, Xeon E5-2630 2x8cores at 2.40GHz)"
set xlabel "Intel X540-AT2 with 8 queues, incomming flows on ix0, outgoing flows on ix1\nHT and APM disabled in BIOS, harvest mask=351"
...
# Ploting!
plot "gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 11-head" ls 1, \
	 ...
	 "../fbsd10.2/gnuplot.data" using 0:2:3:4 with yerrorbars lc rgb 'green' pt 1 lw 2 notitle
