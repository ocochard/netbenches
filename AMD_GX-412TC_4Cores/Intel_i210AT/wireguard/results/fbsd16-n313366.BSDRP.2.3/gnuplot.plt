...
# output
set terminal png truecolor size 1500,900 font "Gill Sans,20"
...
set title noenhanced "In-kernel WireGuard throughput (IPv4 and IPv6)\nPC Engines APU2 (4 cores AMD GX-412T and Gigabit Intel i210AT)"
...
plot "inet4.data" using 2:3:4:xticlabels(1) with histogram title "IPv4" ls 2, \
     ...
     "inet4.data" using ($0-0.1):($2+12):2 with labels notitle, \
     "inet6.data" using ($0+0.1):($2+12):2 with labels notitle
