...
set title noenhanced "Impact of enabling firewalls on FreeBSD 16-CURRENT n311215 forwarding performance\nPC Engines APU2 (4 cores AMD GX-412T and Gigabit Intel i210AT)"
set xlabel "Note: Minimum firewall rules, kernel without option RSS (netisr direct dispatch)"
