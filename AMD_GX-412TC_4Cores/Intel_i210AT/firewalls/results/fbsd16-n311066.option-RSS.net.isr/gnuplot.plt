...
set title noenhanced "Impact of enabling firewalls on FreeBSD 16-CURRENT n311066 forwarding performance\nPC Engines APU2 (4 cores AMD GX-412T and Gigabit Intel i210AT)"
set xlabel "Note: Minimum firewall rules, kernel option RSS, net.isr.maxthreads=-1 and bindthreads=1"
