...
set title "Comparing stable vs head and ipfw/pf impact on forwarding performance\n (PC Engines APU2C4, 4 cores AMD GX-412TC Processor and Intel i210AT)"
...
# Ploting!
plot "r318516stable.data" using 0:2:xtic(1) with boxes title "FreeBSD 11-stable r318516" ls 1, \
	 "r318516stable.data" using 0:2:3:4 with yerrorbars lc rgb 'red' pt 1 lw 2 notitle, \
	 "r318516current.data" using 0:2:xtic(1) with boxes title "FreeBSD 12-head r318516" ls 2, \
	 "r318516current.data" using 0:2:3:4 with yerrorbars lc rgb 'green' pt 1 lw 2 notitle
