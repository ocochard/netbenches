...
set title noenhanced "Impact of enabling firewalls on FreeBSD main c255632 (13 -head) forwarding performance\nPC Engines APU2 (4 cores AMD GX-412T and Gigabit Intel i210AT)"
set xlabel "Note: 2 static routes, minimum firewall rules, ICMP redirect disabled"
