...
# Ploting!
plot "r317849-VIMAGE.data" using 0:2:xtic(1) with boxes title "FreeBSD 12-head r317849 with VIMAGE" ls 2, \
	 "r317849-VIMAGE.data" using 0:2:3:4 with yerrorbars lc rgb 'green' pt 1 lw 2 notitle, \
	 "r317849.data" using 0:2:xtic(1) with boxes title "FreeBSD 12-head r317849" ls 1, \
