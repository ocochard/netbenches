...
# Ploting!
plot "11.1GENERIC.inet4.data" using 2:3:4:xticlabels(1) with histogram title "inet4" ls 2, \
	 "11.1GENERIC.inet6.data" using 2:3:4:xticlabels(1) with histogram title "inet6" ls 3