...
set title "Impact of r315217 on forwarding performance\n (PC Engines APU2C4, 4 cores AMD GX-412TC and Intel NIC i210AT)"
set xlabel "default igb drivers values, harvest.mask=351"
...
# Ploting!
plot "r315216.data" using 0:2:xtic(1) with boxes title "r315216" ls 2, \
	 "r315216.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
	 "r315217.data" using 0:2:xtic(1) with boxes title "r315217" ls 1, \
	 "r315217.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle
