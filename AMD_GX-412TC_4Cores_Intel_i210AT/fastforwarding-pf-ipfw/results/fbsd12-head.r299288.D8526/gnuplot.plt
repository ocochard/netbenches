...
set title "Impact of D8526 on ipfw/pf/forwarding performance on FreeBSD 12-head r299288\n (PC Engines APU2C4, 4 cores AMD GX-412TC Processor and Intel i210AT)"
...
# Ploting!
plot "299288D8526.data" using 0:2:xtic(1) with boxes title "FreeBSD 12-head r299288 with D8526" ls 2, \
	 "299288D8526.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
	 "299288.data" using 0:2:xtic(1) with boxes title "FreeBSD 12-head r299288" ls 1, \
	 "299288.data" using 0:2:3:4 with yerrorbars lc rgb 'grey' pt 1 lw 2 notitle
