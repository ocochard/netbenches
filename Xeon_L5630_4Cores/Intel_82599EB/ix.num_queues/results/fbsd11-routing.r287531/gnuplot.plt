...
# Ploting!
plot "gnuplot.data" with errorbars title 'FreeBSD project/routing r287531' ls 1, \
	"gnuplot.data" with lines notitle ls 1, \
	"../fbsd11-head.r287478/gnuplot.data" with errorbars title 'FreeBSD head r287478' ls 2, \
