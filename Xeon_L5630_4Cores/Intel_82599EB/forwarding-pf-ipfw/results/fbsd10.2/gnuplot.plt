...
set xlabel "Note: 10Giga Intel 82599EB NIC, fastforwarding is enabled for all ipfw and pf benchs. 2 firewall rules only"
...
# Ploting!
plot "gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 10.2" ls 1, \
	 "gnuplot.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
     "../fbsd10.1/gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 10.1" ls 2, \
	 "../fbsd10.1/gnuplot.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle
