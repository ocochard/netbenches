...
set xtics 1
set title noenhanced "Impact of enabling firewalls on FreeBSD's forwarding performance\nDell PowerEdge R630 with 2 Intel E5-2650 v4 2.2Ghz (2x12 cores) and Mellanox ConnectX-4 LC (10Giga DAC cable)"
set xlabel "Note: Minimum firewall rules, HyperThreading and LRO/TSO disabled, harvest.mask=351\nYandex patches applied: AFDATA lock, RADIX lock, IPFW-statefull-lockless(D12685)"
...
f(x)=14800000
# Ploting!
plot f(x) with lines title "10Gigabit line-rate" linestyle 3 lw 4, \
"gnuplot.data" using 2:3:4:xticlabels(1) with histogram title "FreeBSD 12-head r328085" ls 2
