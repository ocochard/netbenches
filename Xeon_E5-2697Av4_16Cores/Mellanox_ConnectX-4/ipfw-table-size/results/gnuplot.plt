...
set title noenhanced "Impact of ipfw blacklist table on FreeBSD r361019 forwarding performance\nXeon E5-2697A v4 16cores and Mellanox ConnectX-4 100GBase-SR4"
set xlabel "Number of entries in blacklist table"
...
g(x)=28000000
# Ploting!
plot "gnuplot.data" using 2:3:4:xticlabels(1) with histogram title '' ls 2
