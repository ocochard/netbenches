...
set title noenhanced "Number of queues impact on forwarding performance\n(HP ProLiant DL360p Gen8 with 8 cores Intel Xeon E5-2650 2.60GHz, Chelsio T540-CR)"
set xlabel noenhanced "Number of queues (machdep.hyperthreading_allowed=0)"
...
# Ploting!
plot "fbsd11.1.data" using 0:2:xtic(1) with lines title "FreeBSD 11.1" ls 1, \
	 "fbsd11.1.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
	 "fbsd11.1-yandex.data" using 0:2:xtic(1) with lines title "FreeBSD 11.1 with Yandex patches and harvest.mask=351" ls 2, \
	 "fbsd11.1-yandex.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
	 e(x) with lines title "linear reference (updated)" linestyle 3 lw 1