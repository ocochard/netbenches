...
set title noenhanced "Impact of enabling firewalls on FreeBSD 13-main c255632 forwarding performance\nXeon E5-2697A v4 16cores and Mellanox ConnectX-4 100GBase-SR4"
...
plot "inet4.data" using 2:3:4:xticlabels(1) with histogram title "inet4" ls 2, \
	...
	g(x) with lines title "Min req. for 40Gb/s bidir with simple IMIX dist." ls 1 lw 4, \
