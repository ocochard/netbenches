...
set title noenhanced "RELENG vs STABLE vs MAIN on IPv6 firewalling performance\n16 cores Intel Xeon E5-2697A v4 2.60GHz with Mellanox ConnectX-4 100GBase-SR4"
...
g(x)=28000000
# Ploting!
plot "RELEASE12.inet6.data" using 2:3:4:xticlabels(1) with histogram title "RELEASE-12.2" ls 1, \
"STABLE12.inet6.data" using 2:3:4:xticlabels(1) with histogram title "STABLE-12" ls 5, \
	 "RELEASE13.inet6.data" using 2:3:4:xticlabels(1) with histogram title "RELEASE-13.0" ls 3, \
	 "STABLE13.inet6.data" using 2:3:4:xticlabels(1) with histogram title "STABLE-13" ls 4, \
     "MAIN.inet6.data" using 2:3:4:xticlabels(1) with histogram title "MAIN" ls 2, \
