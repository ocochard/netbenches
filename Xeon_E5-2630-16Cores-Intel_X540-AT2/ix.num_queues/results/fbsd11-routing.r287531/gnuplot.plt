...
set title "Impact of RX/TX queue number on fastforwarding performance (Supermicro X10DRi-LN4+, Xeon E5-2630 2x8cores at 2.40GHz)"
set xlabel "Intel X540-AT2 queue number\nHT and APM disabled in BIOS, harvest mask=351"
...
plot "gnuplot.data" with errorbars title 'FreeBSD 11-routing.r287531' ls 1, \
	...
	"../fbsd10.2/gnuplot.data" with errorbars title 'FreeBSD 10.2' ls 3, \
	"../fbsd10.2/gnuplot.data" with lines notitle ls 3
