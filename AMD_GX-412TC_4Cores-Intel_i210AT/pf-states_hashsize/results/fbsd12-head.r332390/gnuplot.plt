...
# output
set terminal png size 1920,1080 font "Gill Sans,22" noenhanced
...
set title "Impact of pf.states_hashsize with default max 100K states (PC Engines APU2C4, 4 cores AMD GX-412TC Processor and Intel i210AT)"
set xlabel "pf.states_hashsize value (power of 2)"
set ylabel "Packets per second (minimum size, 50K flows: 100K state entries)\n minimum,median,maximum values of 5 benchs"
...
# Ploting!
plot "gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 12.0-CURRENT r336223" ls 2, \
