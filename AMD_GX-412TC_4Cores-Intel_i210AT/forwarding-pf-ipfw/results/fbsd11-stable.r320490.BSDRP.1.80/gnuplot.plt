...
set title noenhanced "Impact of enabling ipfw/pf/ipf on BSDRP 1.80 (FreeBSD 11.1-PRERELEASE) forwarding performance\n(PC Engines APU2C4, 4 cores AMD GX-412TC Processor and Intel i210AT)"
set xlabel noenhanced "Note: Minimum firewall rules, harvest.mask=351, hw.igb.rx_process_limit=-1, AFDATA and RADIX locks patched"
