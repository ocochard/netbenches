...
set title noenhanced "HyperThreading and NIC's queues impact on forwarding performance\nXeon E5 2650L (10c,20t) and Chelsio T540-CR"
set xlabel noenhanced "HyperThreading status and number of queues (LRO&TSO disabled)"
...
# Ploting!
plot "gnuplot.data" using 0:2:xtic(1) with lines title "FreeBSD 12-STABLE r354440" ls 1, \
