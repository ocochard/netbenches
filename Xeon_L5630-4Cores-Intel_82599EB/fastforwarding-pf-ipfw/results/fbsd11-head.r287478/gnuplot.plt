...
set title "Impact of enabling ipfw/pf on fastforwarding performance (IBM System x3550 M3 with 4 cores Intel Xeon L5630)"
set xlabel "10Giga Intel 82599EB NIC, fastforwarding enabled for ipfw and pf benchs. 2 firewall rules only. harvest.mask=351"
...
plot "gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 11-routing r287531" ls 1, \
	 ...
	 "../fbsd11-head.r287478/gnuplot.data" using 0:2:3:4 with yerrorbars lc rgb 'white' pt 1 lw 2 notitle, \
	 ...
	 "../fbsd10.1/gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 10.1" ls 4, \
	 "../fbsd10.1/gnuplot.data" using 0:2:3:4 with yerrorbars lc rgb 'yellow' pt 1 lw 2 notitle
