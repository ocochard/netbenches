...
# Ploting!
plot "gnuplot.data" using 0:2:xtic(1) with boxes title "FreeBSD 11-stable r312663" ls 2, \
	 "gnuplot.data" using 0:2:3:4 with yerrorbars lc rgb 'black' pt 1 lw 2 notitle, \
	 "10.3.data" using 0:2:xtic(1) with boxes title "FreeBSD 10.3" ls 1, \
	 "10.3.data" using 0:2:3:4 with yerrorbars lc rgb 'grey' pt 1 lw 2 notitle, \
