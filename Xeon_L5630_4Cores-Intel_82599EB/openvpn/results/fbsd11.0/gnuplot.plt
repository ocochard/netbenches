...
set title "OpenVPN performance on IBM System x3550 M3 with quad cores (Intel Xeon L5630 2.13GHz, HT disabled)"
set xlabel "AESNI used, fast-io enabled, UDP load of 500 Bytes\nMethodology for Benchmarking IPsec Gateways:\nhttp://www.mecs-press.org/ijcnis/ijcnis-v4-n9/IJCNIS-V4-N9-1.pdf"
...
# Ploting!
plot "gnuplot.data.max" using 0:2:xtic(1) with boxes title "FreeBSD 11.0, Open 2.4.0" ls 1, \
