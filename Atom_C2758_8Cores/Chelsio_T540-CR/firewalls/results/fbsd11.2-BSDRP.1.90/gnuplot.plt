...
set title noenhanced "Impact of enabling ipfw/pf/ipf on BSDRP 1.90\n(SuperMicro 5018A-FTN4, 8 cores ATOM C2758 and Chelsio T540-CR)"
set xlabel "Note: Minimum firewall rules, harvest.mask=351, AFDATA and RADIX locks patched and pf MFC"
...
e(x)=7000000
# Ploting!
plot e(x) with lines title "Minimum throughput requiered for 10Gbit full-duplex IMIX" ls 4 lw 4, \
