...
set title noenhanced "Impact of D27401 on forwarding performance\nSuperMicro SuperServer 501A-FTN4 with 8 cores Atom C2758 and Chelsio T540-CR"
...
h(x)=7000000
# Ploting!
plot "gnuplot-inet4.data" using 2:3:4:xticlabels(1) with histogram title "inet" ls 2, \
	 "gnuplot-inet6.data" using 2:3:4:xticlabels(1) with histogram title "inet6" ls 3
