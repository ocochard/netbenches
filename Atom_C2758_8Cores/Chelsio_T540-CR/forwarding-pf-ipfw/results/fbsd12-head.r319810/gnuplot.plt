...
# Ploting!
plot "inet4.data" using 0:2:xtic(1) with boxes title "inet4" ls 2, \
	 "inet4.data" using 0:2:3:4 with yerrorbars lc rgb 'green' pt 1 lw 2 notitle, \
	 "inet6.data" using 0:2:xtic(1) with boxes title "inet6" ls 1, \
	 "inet6.data" using 0:2:3:4 with yerrorbars lc rgb 'red' pt 1 lw 2 notitle
