...
set title noenhanced "Impact of enabling firewalls on FreeBSD 16-CURRENT n313366 (BSDRP 2.3) forwarding performance\nSupermicro SYS-5018A-FTN4 (8 cores Intel Atom C2758 and 10-Gigabit Chelsio T520-SO)"
set xlabel "Note: Minimum firewall rules, GENERIC kernel, net.isr.maxthreads=1 (default)"
