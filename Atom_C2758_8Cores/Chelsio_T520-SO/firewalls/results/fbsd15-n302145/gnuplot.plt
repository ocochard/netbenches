...
set title noenhanced "Impact of firewalls on FreeBSD 15-head n302145 forwarding performance\nSuperMicro SuperServer 501A-FTN4 with 8 cores Atom C2758 and Chelsio T520-SO"
...
h(x)=7000000
# Ploting!
# head -1 gnuplot.data > inet4.data
# cp inet4.data inet6.data
# grep inet4 gnuplot.data > inet4.data
# sed -i "" -e "s|\.inet4||" inet4.data
# grep inet6 gnuplot.data > inet6.data
# sed -i "" -e "s|\.inet6||" inet6.data
